...
void ov7725_eagle_port_init()
{
    ...
    dma_portx2buff_init(CAMERA_DMA_CH, (void *)&PTC_B0_IN, (void *)ov7725_eagle_img_buff, PTB21, DMA_BYTE1, CAMERA_DMA_NUM, DADDR_KEEPON);
    ...
    port_init(PTB21, ALT1 | DMA_FALLING | PULLDOWN );         //PCLK

    port_init(PTB22, ALT1 | IRQ_RISING  | PULLDOWN | PF);     //场中断，上拉，上降沿触发中断，带滤波
